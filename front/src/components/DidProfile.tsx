	...
	return (
		<>
			<View style={NftProfileLayout.nftProfileWrap}>
				<ImageBackground
					source={{ uri: bgImg }}
					style={NftProfileLayout.puppyThumbnail}
					imageStyle={{ borderRadius: 10 }}
				>
					<View style={NftProfileLayout.darkLayout}></View>
					<View style={NftProfileLayout.onNftInfo}>
						<Text style={NftProfileLayout.myDogName}>
							<Text style={NftProfileLayout.boldMyDogName}>{dogName}</Text>
						</Text>
						<Text style={NftProfileLayout.createdDateTitle}>
							{createdTitle}
						</Text>
					...
					<TouchableOpacity
						activeOpacity={0.7}
						style={NftProfileLayout.editButtonWrap}
						onPress={() =>
							navigation.navigate("EditProfile", { selectedNo: dogNo })
						}
					>
						<View style={NftProfileLayout.editButton}>
							<Text style={NftProfileLayout.editButtonText}>상세보기</Text>
						</View>
					</TouchableOpacity>
				</ImageBackground>
			</View>
